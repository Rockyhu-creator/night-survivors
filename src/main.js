...
document.getElementById('btn-victory-retry').addEventListener('click', () => game.startRun());
document.getElementById('btn-victory-home').addEventListener('click', () => game.showTitle());
document.getElementById('btn-codex').addEventListener('click', () => game.ui.showCodex());
document.getElementById('btn-codex-hub-back').addEventListener('click', () => game.ui.hideCodex());
document.getElementById('btn-codex-hub-topback').addEventListener('click', () => game.ui.hideCodex());
document.getElementById('btn-codex-artifacts-back').addEventListener('click', () => game.ui.backToCodexHub());
