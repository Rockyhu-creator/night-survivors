...
> 供新会话窗口快速接手项目的上下文文档。最后更新：2026-07-27（v2.3 升级卡合成提示置底 + 圣水洗礼槽外固有(双生武装/圣徒不占槽、双源合并两级) 后）
