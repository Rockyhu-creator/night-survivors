...
```
(本次文档提交) docs: v5.4 CHANGELOG + HANDOFF 同步(宠物渲染坐标修复:世界坐标未转屏幕坐标漏传cam→画屏幕外不可见,指向 3651162) + §11 回填 4399b08(v5.3 文档提交) | 自身哈希待下一版回填
