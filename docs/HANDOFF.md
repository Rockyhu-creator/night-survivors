...
```
(本次文档提交) docs: v5.1 宠物帧腿缝纯白岛残留修复(remove_bg加_fill_white_holes:删不连通四边+纯白min>250孤岛;13帧重生成,诊断残留纯白岛=0/猫白毛240-249保留5205px)+CHANGELOG补条目 | 自身哈希待下一版回填
