...
```
(本次文档提交) docs: v4.3.4 CHANGELOG + HANDOFF 同步(指向 2141d7a) + §0x 小节(v4.3.4: apostle高保真重绘,亮度30→82/255) | tag v4.3.4 指向此提交（自身哈希无法在提交内容中自引用）
