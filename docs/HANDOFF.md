...
```
(本次文档提交) docs: v4.2 CHANGELOG + HANDOFF 同步(指向 70f21e3) + §0s 小节(v4.2: 白色系精灵暗底重绘 + 血裔角色差异化立绘) + §11 三处索引修复(回填 b5a3e46 此前为占位符 + 补录漏登的 61108b7 + 登记本版 70f21e3) + 头部"最后更新"更新到 2026-08-06 v4.2 | tag v4.2 指向此提交（自身哈希无法在提交内容中自引用）
