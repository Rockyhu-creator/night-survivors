...
```
(本次文档提交) docs: v4.3.5 CHANGELOG + HANDOFF 同步(指向 88fd903) + §0y 小节(v4.3.5: 永夜化身boss重绘,亮度143→82/255) | tag v4.3.5 指向此提交（自身哈希无法在提交内容中自引用）
