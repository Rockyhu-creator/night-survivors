...
```
(本次文档提交) docs: v5.3 CHANGELOG + HANDOFF 同步(宠物拾取引用修复 pickupSystem→pickups + 跟随算法重写,指向 0963e92) + §11 回填 a023c0b(v5.2 文档提交) | 自身哈希待下一版回填
