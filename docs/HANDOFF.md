...
```
(本次文档提交) docs: v4.4 CHANGELOG + HANDOFF 同步(指向 3c0112c) + §0aa 小节(v4.4: 宠物战斗拾取系统) + §11 回填 f5af563(v4.3.6 文档提交) | tag v4.4 指向此提交（自身哈希无法在提交内容中自引用）
