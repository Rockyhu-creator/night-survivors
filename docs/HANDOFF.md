...
```
(本次文档提交) docs: v4.3 CHANGELOG + HANDOFF 同步(指向 23c1e36) + §0t 小节(v4.3: portrait选择卡片立绘同步) + §11 回填 b28e24d(v4.2 文档提交) + 头部"最后更新"更新到 2026-08-07 v4.3 | tag v4.3 指向此提交（自身哈希无法在提交内容中自引用）
