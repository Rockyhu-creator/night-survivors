...
```
(本次文档提交) docs: v5.2 CHANGELOG + HANDOFF 同步(宠物屏幕钳制/吸附范围扩大/使徒光环修复/宠物改名肥波肥强,指向 4f0cdf1) + §11 回填 57a018e(v5.1 腿缝修复提交) | 自身哈希待下一版回填
