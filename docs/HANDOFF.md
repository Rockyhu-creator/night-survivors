...
```
(本次文档提交) docs: v4.3.2 CHANGELOG + HANDOFF 同步(指向 1743a2d) + §0v 小节(v4.3.2: 血裔精灵清晰度+放大10%+键控统一) + §11 回填 f2e1525(v4.3.1 文档提交) | tag v4.3.2 指向此提交（自身哈希无法在提交内容中自引用）
