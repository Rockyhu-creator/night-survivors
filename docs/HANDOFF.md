...
```
(本次文档提交) docs: v4.3.6 CHANGELOG + HANDOFF 同步(指向 d4981cb) + §0z 小节(v4.3.6: 永夜使徒无初始武器死锁修复,槽外固有永夜光环起手) | tag v4.3.6 指向此提交（自身哈希无法在提交内容中自引用）
