...
```
(本次文档提交) docs: v5.0 CHANGELOG + HANDOFF 同步(指向 3c0112c) + §0aa 小节(v5.0: 宠物战斗拾取系统) + §11 回填 8c1a76c(v5.0 重标号文档提交) | tag v5.0 指向此提交（自身哈希无法在提交内容中自引用）
8c1a76c docs: v5.0(由 v4.4 重标号) CHANGELOG + HANDOFF 同步(指向 3c0112c) + §0aa 小节(v5.0: 宠物战斗拾取系统) + §11 回填 f5af563(v4.3.6 文档提交)
