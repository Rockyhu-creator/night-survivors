...
> 供新会话窗口快速接手项目的上下文文档。最后更新：2026-07-27（v2.2 武器弹丸 + 8 神器觉醒弹幕/形态差异化 + 镇魂钟鸣红圈血钟 + getShapeSprite 离屏缓存保性能后）
